...
$thumbnailsub_id = get_woocommerce_term_meta($term_id, 'thumbnail_id', true);
$termImage = wp_get_attachment_url($thumbnailsub_id);
$title = get_queried_object()->name;
$arr_title = explode(" ", $title);
$last_title = '';
if (count($arr_title) > 1) {
  $last_title = $arr_title[count($arr_title) - 1];
  unset($arr_title[count($arr_title) - 1]);
}
  ...
  <div class="gap-11 lg:flex lg:items-center lg:flex-wrap">
    <div class="font-Playfair py-4 lg:w-[30%]">
      <h2 class="mb-4 lg:mb-7 text-center lg:text-left">
        <span class="text-[32px] lg:text-[56px] text-[#62606a] italic font-light tracking-[1px]"><?= $title ?>
        </span>
        <span class="text-[32px] lg:text-[56px] text-[#ba9b63] font-light tracking-[1px]"><?= $last_title ?></span>
      </h2>
      <p class="font-SFPro line-clamp-3 mt-1 mb-6 lg:mt-3 lg:mb-5 leading-tight text-[16px]">
        <?php the_archive_description() ?>
      </p>
    </div>
    <div class="lg:flex-1 flex justify-center">
      <img class="w-[375px] lg:w-[940px]" src="<?= $termImage ?>" alt="" />
    </div>
  </div>
</section>
    ...
    <div class="section-body">
      <div class="swiper feature-category-slides">
        <div class="swiper-wrapper">
          <?php $theme_class->get_Children_term($term_id) ?>
        </div>
...
<div class="filter-product border-y-[1px] border-[#cccccc] my-[40px] lg:my-[80px]">
    ...
    <div class="flex justify-start items-center py-5">
      <div class="flex justify-start items-center gap-4">
        <div id="open-products-filter" class="flex items-center gap-2 cursor-pointer">
          ...
          <p class="uppercase font-SFPro text-[14px] font-medium " href="">Bộ lọc</a>
        </div>
        <a class="hidden lg:block uppercase font-SFPro text-[14px] font-medium text-[#78828a] hover:underline hover:border-[#78828a]" href="">Xoá bộ lọc</a>
      </div>
      <div></div>
    </div>
    <div class="flex justify-between gap-8 items-center">
      <div class="flex gap-2">
        <span class="uppercase font-SFPro text-[14px] text-[#ba9b63] font-semibold">
          80
        </span>
      ...
      <div class="flex items-center gap-8">
        <p class="hidden lg:block uppercase font-SFPro text-[14px] font-semibold" href="">
          Xắp xếp theo :
        </p>
        <div class="flex items-center gap-2">
          <a class="uppercase font-SFPro text-[14px] font-medium text-[#cccccc] hover:underline hover:border-[#cccccc]" href="">Thứ tự a-z</a>
...
<div id="fullscreen-modal" class="fixed inset-0 z-50 overflow-auto bg-gray-800 bg-opacity-75 hidden">
  <div class="bg-white w-full h-full">
    <div class="flex justify-between p-4 ">
      <p class="uppercase font-SFPro text-[14px] font-medium " href="">Bộ lọc</p>
      <a class=" uppercase font-SFPro text-[14px] font-bold text-[#78828a] hover:underline hover:border-[#78828a]" href="">Xoá bộ lọc</a>
...
<section class="list-products">
  <div class="flex max-w-screen-1xl mx-auto px-4">
    ...
    <div id="list-product" class=" grid grid-cols-2 md:grid-cols-4 gap-8 pb-7 border-b-[1px] border-[#ccccc]">
      <?php while (have_posts()) : the_post();
        $product = new WC_Product(get_the_ID());
        $value = $post;
        require('includes/tpl/loop_product_component.php');
      endwhile; ?>
    </div>
  </div>
  <div class="flex justify-center my-5 lg:my-7">
    <button class="flex justify-center gap-1 items-center px-8 py-[10px] rounded-md border-2 border-[#ba9b63] text-[#ba9b63] uppercase">
    ...
    <div class="overflow-hidden">
      <ul id="room-space-tabs" class="nav room-space-tab flex justify-start space-x-4 overflow-auto whitespace-nowrap pb-7 pl-2 lg:pl-0 lg:justify-center lg:space-x-11">
        <li class="nav-item room-space-tabs__item">
          <a class="font-SFPro lg:text-[20px] font-semibold text-[#1f1f1f] cursor-pointer uppercase py-5 px-1 hover:text-[#ba9b63] active" aria-current="page" data-id="tab1">Phòng Khách</a>
        </li>
        <li class="nav-item room-space-tabs__item">
          <a class="font-SFPro text-[14px] lg:text-[20px] font-semibold text-[#1f1f1f] cursor-pointer uppercase py-3 lg:py-5 px-1 hover:text-[#ba9b63]" data-id="tab2">Phòng Bếp</a>
        </li>
        <li class="nav-item room-space-tabs__item">
          <a class="font-SFPro text-[14px] lg:text-[20px] font-semibold text-[#1f1f1f] cursor-pointer uppercase py-3 lg:py-5 px-1 hover:text-[#ba9b63]" data-id="tab3">Phòng Ngủ</a>
        </li>
        <li class="nav-item room-space-tabs__item">
          <a class="font-SFPro text-[14px] lg:text-[20px] font-semibold text-[#1f1f1f] cursor-pointer uppercase py-3 lg:py-5 px-1 hover:text-[#ba9b63]" data-id="tab4">Phòng Làm Việc</a>
        </li>
        <li class="nav-item room-space-tabs__item">
          <a class="nav-link font-SFPro text-[14px] lg:text-[20px] font-semibold text-[#1f1f1f] cursor-pointer uppercase py-3 lg:py-5 px-1 hover:text-[#ba9b63]" data-id="tab5">Không Gian Khác</a>
        </li>
      </ul>
    </div>
  </div>
  <div class="section-body">
    <div class="room-space-tab-content mb-6">
      <div class="tab-content" data-tab-id="tab1">
        <div class="swiper room-space-slide swiper-initialized swiper-horizontal swiper-backface-hidden">
          <div class="swiper-wrapper" id="swiper-wrapper-bd3dff36e8ca1c4c" aria-live="off" style="
                  transform: translate3d(-1547.39px, 0px, 0px);
                  transition-duration: 0ms;
                  transition-delay: 0ms;
                ">
            <div class="swiper-slide swiper-slide-prev" role="group" aria-label="2 / 3" data-swiper-slide-index="1" style="margin-right: 25px">
              <img srcset="./images/banner2.jpg 2x" class="img-fluid lg:h-[740px]" alt="" />
            </div>
            <div class="swiper-slide swiper-slide-active" role="group" aria-label="3 / 3" data-swiper-slide-index="2" style="margin-right: 25px">
              <img srcset="./images/banner2.jpg 2x" class="img-fluid lg:h-[740px]" alt="" />
            </div>
            <div class="swiper-slide swiper-slide-next" role="group" aria-label="1 / 3" data-swiper-slide-index="0" style="margin-right: 25px">
              <img srcset="./images/banner2.jpg 2x" class="img-fluid lg:h-[740px]" alt="" />
            </div>
          </div>
...
<section class="projects lg:mt-[72px]">
  <div class="max-w-screen-1xl mx-auto px-4">
    <div class="font-Playfair text-center lg:py-4 mb-[18px]">
      <h2>
        <span class="text-xl lg:text-[36px] text-[#1f1f1f] italic font-light tracking-[1px]">Dự án</span>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="projects-item">
              ...
              <div class="text-center lg:text-left">
                <h3 class="mt-[14px] mb-[7px]">
                  <a href="" class="text-xl font-bold text-[#1F1F1F] font-berling md:font-SFPro">Dự án may đo nội thất mã 002</a>
                </h3>
                <p class="text-[#1F1F1F] font-SFPro text-center lg:text-left">
          ...
          <div class="swiper-slide">
            <div class="projects-item">
              ...
              <div class="text-center lg:text-left">
                <h3 class="mt-[14px] mb-[7px]">
                  <a href="" class="text-xl font-bold text-[#1F1F1F] font-berling md:font-SFPro">Dự án may đo nội thất mã 004</a>
                </h3>
          ...
          <div class="swiper-slide">
            <div class="projects-item">
              ...
              <div class="text-center lg:text-left">
                <h3 class="mt-[14px] mb-[7px]">
                  <a href="" class="text-xl font-bold text-[#1F1F1F] font-berling md:font-SFPro">Dự án may đo nội thất mã 113</a>
                </h3>
                <p class="text-[#1F1F1F] font-SFPro">
...
<section class="related-articles lg:mt-[72px] mb-10 lg:mb-[70px]">
  <div class="max-w-screen-1xl mx-auto px-4">
    <div class="font-Playfair text-center lg:py-4 mb-[18px]">
      <h2>
        <span class="text-xl lg:text-[36px] text-[#1f1f1f] italic font-light tracking-[1px]">Bài viết</span>
        <span class="text-xl lg:text-[36px] text-[#ba9b63] font-[500] tracking-[1px]">
          liên quan</span>
      </h2>
    </div>
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div>
              <div class="text-left">
                <h3 class="mt-[14px] mb-[7px]">
                  <a href="" class="text-xl font-bold text-[#1F1F1F] font-berling md:font-SFPro">Có thể bạn chưa biết câu chuyện về thương hiệu Iris của
                    chúng tôi
                  </a>
                </h3>
                <div class="flex items-center gap-2">
                  <p class="text-[#899299] text-[16px] font-SFPro text-center lg:text-left">
                    November 1, 2023
                  </p>
                  |
                  <p class="text-[#899299] text-[16px] font-SFPro text-center lg:text-left">
